 ...
 */
package org.osate2.bayes.dtbn.Inference.factor;

import java.util.Arrays;
import java.util.Comparator;

import org.osate2.bayes.dtbn.Inference.factor.arraywrapper.IArrayWrapper;
import org.osate2.bayes.dtbn.Inference.factor.opcache.DivisionCache;
import org.osate2.bayes.dtbn.Inference.util.AddressCalc;
...
public class SparseFactor extends AbstractFactor {
    ...
    private int[] sortByKey(final double[] key, int[] array) {
        int[] permutation = sort(indexArray(key.length),
                (o1, o2) -> -Double.compare(key[o1], key[o2]));
